...
>(({ className, ...props }, ref) => (
    <AlertDialogPrimitive.Overlay
        ref={ref}
        className={cn(
            "fixed inset-0 z-50 bg-black/25 backdrop-blur-lg",
    ...
    <AlertDialogPortal>
        ...
        <AlertDialogPrimitive.Content
            ...
            className={cn(
                ...
                "p-7 sm:p-6",
                "shadow-[0_16px_48px_rgba(31,38,135,0.25)]",
        ...
        >
            ...
            <AlertDialogPrimitive.Cancel
                className="absolute right-4 top-4 rounded-full p-1 opacity-70 transition hover:opacity-100 hover:bg-black/5"
            >
                <X className="h-4 w-4" />
